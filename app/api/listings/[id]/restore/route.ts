// app/api/listings/[id]/restore/route.ts
...
import { restoreListingToDraft } from "@/src/server/modules/listings/listings.service";
...
export async function POST(req: Request, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    await restoreListingToDraft(listingId, site.id);
